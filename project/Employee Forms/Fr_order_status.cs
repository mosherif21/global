...
namespace project
{
    public partial class Fr_Return : Form
    {
        //database connection
       ...
       #region get photo from database
        ...
        private void initiate_orders()
        {
            ...
            usc_order_status[] usc_My_Orders = new usc_order_status[order_ids.Count];
            ...
            else
            {
                ...
                for (f = 0; f < order_ids.Count; f++)
                {
                    ...
                    data.Fill(da2);
                    usc_My_Orders[f] = new usc_order_status();
        ...
        private void Fr_Return_Load(object sender, EventArgs e)
        {
            initiate_orders();
        }
    }
